  ...
  <div class="flex flex-col md:flex-row items-center gap-y-12 gap-x-16 pt-14">
    ...
    <div
      ...
      <p class="text-justify leading-7">
        من <strong>سامان صفائی</strong> ساکن <b>تهران</b> هستم و دیپلمم رو از
        دبیرستان غیر دولتی دکتر حسابی گرفتم. برنامه نویس و توسعه دهنده
        <b>فرانت اند</b> با استفاده از فریمورک <b>Vue.js</b> هستم و به این
        فریمورک به خاطر سرعت بالا و همینطور حجم باندل کمش علاقه دارم. علاقه
        زیادی به کار گروهی و همینطور <b>یادگیری</b> بیشتر این فریمورک دارم و روز
        به روز خودم رو <b>آپدیت</b> میکنم.
      </p>
